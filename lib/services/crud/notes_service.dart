...
class NotesService {
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    //make sure owner exists in our database
...
class DatabaseNote {
  ...
  final String text;
  final bool
      isSyncedWithCloud; //we're not gonna use it, it's just as an example of how we can add more fields
  ...
  DatabaseNote.fromRow(Map<String, Object?> map)
      : id = map[idColumn] as int,
        ...
        isSyncedWithCloud = map[isSyncedWithCloudColumn] as int == 1
            ? true
            : false; // we expressed bool as int
